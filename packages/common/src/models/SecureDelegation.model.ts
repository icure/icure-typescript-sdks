...
export class SecureDelegation {
    ...
    constructor(json: Partial<ISecureDelegation> & { secretIds: string[]; encryptionKeys: string[]; owningEntityIds: string[]; parentDelegations: string[]; permissions: AccessLevelEnum }) {
