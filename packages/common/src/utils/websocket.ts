...
import { AbstractFilterHealthElement, AbstractFilterMaintenanceTask, AbstractFilterPatient, AbstractFilterService, AbstractFilterUser } from '@icure/api'
...
export class WebSocketWrapper {
    ...
    public static async create(url: string, tokenProvider: () => Promise<string>, maxRetries?: number, retryDelay?: number, statusCallbacks?: ConnectionStatusFunctions, messageCallback?: WebSocketWrapperMessageCallback): Promise<WebSocketWrapper> {
