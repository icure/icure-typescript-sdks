...
class MaintenanceTaskFilterWithDataOwner
  extends SortableFilterBuilder<MaintenanceTask, MaintenanceTaskFilterSortStepDecorator>
  implements BaseMaintenanceTaskFilterBuilder<MaintenanceTaskFilterWithDataOwner>, FilterBuilder<MaintenanceTask>
{
