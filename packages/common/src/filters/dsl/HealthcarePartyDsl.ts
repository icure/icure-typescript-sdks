...
export class HealthcarePartyFilter
  extends SortableFilterBuilder<HealthcareParty, HealthcarePartyFilterSortStepDecorator>
  implements BaseHealthcarePartyFilterBuilder<HealthcarePartyFilter>, FilterBuilder<HealthcareParty>
{
...
type NonSortableHealthcarePartyFilter = BaseHealthcarePartyFilterBuilder<HealthcarePartyFilter> &
  FilterBuilder<HealthcareParty>
