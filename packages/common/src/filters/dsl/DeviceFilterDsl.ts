...
export class DeviceFilter extends SortableFilterBuilder<Device, DeviceFilterSortStepDecorator> implements BaseDeviceFilterBuilder<DeviceFilter>, FilterBuilder<Device> {
