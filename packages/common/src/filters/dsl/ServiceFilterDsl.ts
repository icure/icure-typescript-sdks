...
class ServiceFilterWithDataOwner
  extends SortableFilterBuilder<Service, ServiceFilterSortStepDecorator>
  implements BaseServiceFilterBuilder<ServiceFilterWithDataOwner>, FilterBuilder<Service>
{
