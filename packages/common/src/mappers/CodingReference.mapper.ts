...
function toCodeStubContextLabel(domain: CodingReference): string | undefined {
    return domain.contextLabel
}

function toCodingReferenceContextLabel(dto: CodeStub): string | undefined {
    return dto.contextLabel
}
