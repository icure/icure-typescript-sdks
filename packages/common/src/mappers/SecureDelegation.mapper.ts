...
function toSecureDelegationSecretIds(dto: SecureDelegationDto): string[] | undefined {
    return dto.secretIds
}

function toSecureDelegationEncryptionKeys(dto: SecureDelegationDto): string[] | undefined {
    return dto.encryptionKeys
}

function toSecureDelegationOwningEntityIds(dto: SecureDelegationDto): string[] | undefined {
    return dto.owningEntityIds
}

function toSecureDelegationParentDelegations(dto: SecureDelegationDto): string[] | undefined {
