...
export interface UserLikeApi<DSUser, DSPatient> {
     ...
     */
    subscribeToEvents(eventTypes: ('CREATE' | 'UPDATE' | 'DELETE')[], filter: CommonFilter<User>, eventFired: (user: DSUser) => Promise<void>, options?: SubscriptionOptions): Promise<Connection>
