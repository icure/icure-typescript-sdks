...
export abstract class CommonAnonymousApi<DSApi extends CommonApi> {
    ...
    protected constructor(protected readonly msgGtwUrl: string, protected readonly msgGtwSpecId: string, storage?: StorageFacade<string>, keyStorage?: KeyStorageFacade, errorHandler?: ErrorHandler, sanitizer?: Sanitizer) {
