...
export function initializePatientMapper() {
    createMap(mapper, Patient, PatientEntity, forMember_PatientEntity_id(), forMember_PatientEntity_rev(), forMember_PatientEntity_identifier(), forMember_PatientEntity_created(), forMember_PatientEntity_modified(), forMember_PatientEntity_author(), forMember_PatientEntity_responsible(), forMember_PatientEntity_tags(), forMember_PatientEntity_codes(), forMember_PatientEntity_endOfLife(), forMember_PatientEntity_deletionDate(), forMember_PatientEntity_firstName(), forMember_PatientEntity_lastName(), forMember_PatientEntity_names(), forMember_PatientEntity_companyName(), forMember_PatientEntity_languages(), forMember_PatientEntity_addresses(), forMember_PatientEntity_civility(), forMember_PatientEntity_gender(), forMember_PatientEntity_birthSex(), forMember_PatientEntity_mergeToPatientId(), forMember_PatientEntity_mergedIds(), forMember_PatientEntity_alias(), forMember_PatientEntity_active(), forMember_PatientEntity_deactivationReason(), forMember_PatientEntity_deactivationDate(), forMember_PatientEntity_ssin(), forMember_PatientEntity_maidenName(), forMember_PatientEntity_spouseName(), forMember_PatientEntity_partnerName(), forMember_PatientEntity_personalStatus(), forMember_PatientEntity_dateOfBirth(), forMember_PatientEntity_dateOfDeath(), forMember_PatientEntity_timestampOfLatestEidReading(), forMember_PatientEntity_placeOfBirth(), forMember_PatientEntity_placeOfDeath(), forMember_PatientEntity_deceased(), forMember_PatientEntity_education(), forMember_PatientEntity_profession(), forMember_PatientEntity_note(), forMember_PatientEntity_administrativeNote(), forMember_PatientEntity_notes(), forMember_PatientEntity_nationality(), forMember_PatientEntity_race(), forMember_PatientEntity_ethnicity(), forMember_PatientEntity_preferredUserId(), forMember_PatientEntity_picture(), forMember_PatientEntity_externalId(), forMember_PatientEntity_insurabilities(), forMember_PatientEntity_partnerships(), forMember_PatientEntity_patientHealthCareParties(), forMember_PatientEntity_financialInstitutionInformation(), forMember_PatientEntity_medicalHouseContracts(), forMember_PatientEntity_patientProfessions(), forMember_PatientEntity_parameters(), forMember_PatientEntity_properties(), forMember_PatientEntity_hcPartyKeys(), forMember_PatientEntity_aesExchangeKeys(), forMember_PatientEntity_transferKeys(), forMember_PatientEntity_privateKeyShamirPartitions(), forMember_PatientEntity_publicKey(), forMember_PatientEntity_publicKeysForOaepWithSha256(), forMember_PatientEntity_secretForeignKeys(), forMember_PatientEntity_cryptedForeignKeys(), forMember_PatientEntity_delegations(), forMember_PatientEntity_encryptionKeys(), forMember_PatientEntity_encryptedSelf(), forMember_PatientEntity_medicalLocationId(), forMember_PatientEntity_nonDuplicateIds(), forMember_PatientEntity_encryptedAdministrativesDocuments(), forMember_PatientEntity_comment(), forMember_PatientEntity_warning(), forMember_PatientEntity_fatherBirthCountry(), forMember_PatientEntity_birthCountry(), forMember_PatientEntity_nativeCountry(), forMember_PatientEntity_socialStatus(), forMember_PatientEntity_mainSourceOfIncome(), forMember_PatientEntity_schoolingInfos(), forMember_PatientEntity_employementInfos(), forMember_PatientEntity_securityMetadata(), forMember_PatientEntity__type())

    createMap(mapper, PatientEntity, Patient, forMember_Patient_id(), forMember_Patient_rev(), forMember_Patient_identifiers(), forMember_Patient_created(), forMember_Patient_modified(), forMember_Patient_author(), forMember_Patient_responsible(), forMember_Patient_tags(), forMember_Patient_codes(), forMember_Patient_endOfLife(), forMember_Patient_deletionDate(), forMember_Patient_names(), forMember_Patient_languages(), forMember_Patient_addresses(), forMember_Patient_civility(), forMember_Patient_gender(), forMember_Patient_birthSex(), forMember_Patient_mergeToPatientId(), forMember_Patient_mergedIds(), forMember_Patient_active(), forMember_Patient_deactivationDate(), forMember_Patient_deactivationReason(), forMember_Patient_ssin(), forMember_Patient_personalStatus(), forMember_Patient_dateOfBirth(), forMember_Patient_dateOfDeath(), forMember_Patient_placeOfBirth(), forMember_Patient_placeOfDeath(), forMember_Patient_deceased(), forMember_Patient_education(), forMember_Patient_profession(), forMember_Patient_notes(), forMember_Patient_nationality(), forMember_Patient_race(), forMember_Patient_ethnicity(), forMember_Patient_picture(), forMember_Patient_externalId(), forMember_Patient_relatives(), forMember_Patient_patientPractitioners(), forMember_Patient_patientProfessions(), forMember_Patient_properties(), forMember_Patient_systemMetaData())
}

export function mapPatientEntityToPatient(entity: PatientEntity): Patient {
    return mapper.map(entity, PatientEntity, Patient)
}

export function mapPatientToPatientEntity(model: Patient): PatientEntity {
    return mapper.map(model, Patient, PatientEntity)
}
