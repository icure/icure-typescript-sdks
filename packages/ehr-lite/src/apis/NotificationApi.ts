import { CommonApi, MaintenanceTaskLikeApi, MaintenanceTaskLikeApiImpl, mapMaintenanceTaskToNotification, mapNotificationToMaintenanceTask, Notification, MaintenanceTaskDto } from '@icure/typescript-common'
