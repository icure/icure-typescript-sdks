...
export const healthcareProfessionalIdentifiers = (h: HealthcareParty) => {
    const nihiiIdentifier = h.nihii ? new IdentifierEntity({
        system: NIHII_SYSTEM,
        value: h.nihii,
    }) : undefined
    const cbeIdentifier = h.cbe ? new IdentifierEntity({
        system: CBE_SYSTEM,
        value: h.cbe,
    }) : undefined
    const ehpIdentifier = h.ehp ? new IdentifierEntity({
        system: EHP_SYSTEM,
        value: h.ehp,
    }) : undefined
    const ssinIdentifier = h.ssin ? new IdentifierEntity({
        system: SSIN_SYSTEM,
        value: h.ssin,
    }) : undefined
