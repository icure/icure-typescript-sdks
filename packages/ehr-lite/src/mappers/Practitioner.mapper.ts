...
import { Address, CodeStub, HealthcareParty, Identifier as IdentifierDto, PersonName, PropertyStub } from '@icure/api'
...
function forMember_Practitioner_identifiers() {
    return forMember<HealthcareParty, Practitioner>(
        (v) => v.identifiers,
        mapWith(Identifier, IdentifierDto, (h) => {
...
export function initializePractitionerMapper(mapper: Mapper) {
