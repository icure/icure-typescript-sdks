import {
  ...
  DataOwnerApiAware,
  PractitionerApiAware, ObservationApiAware,
...
const AuthenticationApiTestContext =
  AuthenticationApiAware(ObservationApiAware(PatientApiAware(DataOwnerApiAware(PractitionerApiAware(NotificationApiAware(EhrLiteBaseTestContext))))))
