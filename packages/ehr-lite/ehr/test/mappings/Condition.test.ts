...
test.skip('HealthElement mapped to Condition', () => {
...
test.skip('HealthElement mapped to Condition and mapped back to Condition', () => {
    const condition = mapper.map(he, HealthElement, Condition)
...
test.skip('Condition mapped to HealthElement then get the pojo', () => {
    const condition = mapper.map(he, HealthElement, Condition)
