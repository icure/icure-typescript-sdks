    ...
    he = new HealthElement(
        {
            id: "123",
            tags: [
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/condition-clinical", code: "active"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/condition-ver-status", code: "confirmed"}),
                new CodeStub({
                    type: "http://hl7.org/fhir/ValueSet/condition-category",
                    code: "problem-list-item"
                }),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/condition-severity", code: "severe"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "head"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "neck"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "chest"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "abdomen"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "back"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "pelvis"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "left arm"}),
                new CodeStub({type: "http://hl7.org/fhir/ValueSet/body-site", code: "right arm"}),
            ],
            identifiers: [
                ...
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "head"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "neck"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "chest"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "abdomen"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "back"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "pelvis"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "left arm"}),
                new IdentifierEntity({system: "http://hl7.org/fhir/ValueSet/body-site", value: "right arm"}),
            ],
            notes: [
                new AnnotationEntity({markdown: {en: 'This is a note', fr: 'Ceci est une note'}}),
            ]
        }
    )
})
...
test('HealthElement mapped to Condition', () => {
    ...
    expect(Object.values(ClinicalStatusEnum)).toContain(condition?.clinicalStatus)
    expect(condition?.clinicalStatus).toBe('active')
    expect(condition).toHaveProperty('verificationStatus')
    expect(Object.values(VerificationStatusEnum)).toContain(condition?.verificationStatus)
    ...
    // @ts-ignore
    expect([...(condition?.bodySite?.values() ?? [])]?.map(b => b.code)).toEqual(expect.arrayContaining(he!.tags!.filter(t => t.type === "http://hl7.org/fhir/ValueSet/body-site")!.map(t => t!.code)))
});
...
test('HealthElement mapped to Condition and mapped back to Condition', () => {
    ...
    const mapMarkdownsToStrings: (annotation?: (Annotation | AnnotationEntity)) => string[] = (annotation) => Object.entries(annotation?.markdown ?? {}).map(([k, v]) => `${k}|${v}`)
    ...
    expect(he2!.tags!.map(t => t.code)).toEqual(expect.arrayContaining(he!.tags!.map(t => t!.code)))
    ...
    expect(he2!.identifiers!.map(i => i.value)).toEqual(expect.arrayContaining(he!.identifiers!.map(i => i.value)))
    ...
    expect(he2!.notes!.flatMap(n => mapMarkdownsToStrings(n))).toEqual(expect.arrayContaining(he!.notes!.flatMap(n => mapMarkdownsToStrings(n))))
})
