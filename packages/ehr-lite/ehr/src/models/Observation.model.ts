...
export class Observation {
    ...
    static fromJSON(pojo: any): Observation {
        return new Observation({
            ...
            localContent: pojo['localContent'] ? new Map(Object.entries(pojo['localContent']).map(([k, v]: [any, any]) => [k, LocalComponent.fromJSON(v)])) : undefined,
            qualifiedLinks: pojo['qualifiedLinks'] ? new Map(Object.entries(pojo['qualifiedLinks']).map(([k, v]: [any, any]) => [k, new Map(Object.entries(v).map(([k, v]: [any, any]) => [k, v]))])) : undefined,
