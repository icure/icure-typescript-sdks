...
export class Component {
  ...
  static toJSON(instance: Component): any {
    ...
    pojo["measureValue"] = !!instance.measureValue
      ? Measure.toJSON(instance.measureValue)
      : undefined;
    pojo["timeSeries"] = !!instance.timeSeries
      ? TimeSeries.toJSON(instance.timeSeries)
      : undefined;
    pojo["compoundValue"] = instance.compoundValue?.map((item) =>
      Observation.toJSON(item)
    );
  ...
  static fromJSON(pojo: any): Component {
    ...
    if (pojo["fuzzyDateValue"] === undefined)
      instance.fuzzyDateValue = undefined;
    instance.fuzzyDateValue = pojo["fuzzyDateValue"];
    if (pojo["measureValue"] === undefined) instance.measureValue = undefined;
    instance.measureValue = !!pojo["measureValue"]
      ? Measure.fromJSON(pojo["measureValue"])
      : undefined;
    if (pojo["timeSeries"] === undefined) instance.timeSeries = undefined;
    instance.timeSeries = !!pojo["timeSeries"]
      ? TimeSeries.fromJSON(pojo["timeSeries"])
      : undefined;
    if (pojo["compoundValue"] === undefined) instance.compoundValue = undefined;
    instance.compoundValue = pojo["compoundValue"]?.map((item: any) =>
      Observation.fromJSON(item)
    );
