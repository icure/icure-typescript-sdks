...
function forMember_Content_numberValue() {
    return forMember<Component, Content>(v => v.numberValue, mapFrom(v => v.numberValue))
}

function forMember_Content_booleanValue() {
    return forMember<Component, Content>(v => v.booleanValue, mapFrom(v => v.booleanValue))
}

function forMember_Content_instantValue() {
    return forMember<Component, Content>(v => v.instantValue, mapFrom(v => v.instantValue))
}

function forMember_Content_fuzzyDateValue() {
    return forMember<Component, Content>(v => v.fuzzyDateValue, mapFrom(v => v.fuzzyDateValue))
}
...
function forMember_Content_measureValue() {
    return forMember<Component, Content>(v => v.measureValue, mapWith(Measure, MeasureEntity, v => v.measureValue))
}
...
function forMember_Content_timeSeries() {
    return forMember<Component, Content>(v => v.timeSeries, mapWith(TimeSeries, TimeSeriesEntity, v => v.timeSeries))
}

function forMember_Content_compoundValue() {
    return forMember<Component, Content>(v => v.compoundValue, mapWith(Service, Observation, v => v.compoundValue))
}

function forMember_Content_ratio() {
    return forMember<Component, Content>(v => v.ratio, mapWith(Measure, MeasureEntity, v => v.ratio))
}

function forMember_Content_range() {
    return forMember<Component, Content>(v => v.range, mapWith(Measure, MeasureEntity, v => v.ratio))
}

function forMember_Component_numberValue() {
    return forMember<Content, Component>(v => v.numberValue, mapFrom(v => v.numberValue))
}

function forMember_Component_booleanValue() {
    return forMember<Content, Component>(v => v.booleanValue, mapFrom(v => v.booleanValue))
}

function forMember_Component_instantValue() {
    return forMember<Content, Component>(v => v.instantValue, mapFrom(v => v.instantValue))
}

function forMember_Component_fuzzyDateValue() {
    return forMember<Content, Component>(v => v.fuzzyDateValue, mapFrom(v => v.fuzzyDateValue))
}

function forMember_Component_measureValue() {
    return forMember<Content, Component>(v => v.measureValue, mapFrom(v => v.measureValue))
}

function forMember_Component_timeSeries() {
    return forMember<Content, Component>(v => v.timeSeries, mapWith(TimeSeriesEntity, TimeSeries, v => v.timeSeries))
}

function forMember_Component_compoundValue() {
    return forMember<Content, Component>(v => v.compoundValue, mapWith(Service, Observation, v => v.compoundValue))
}

function forMember_Component_ratio() {
    return forMember<Content, Component>(v => v.ratio, mapWith(MeasureEntity, Measure, v => v.ratio))
}

function forMember_Component_range() {
    return forMember<Content, Component>(v => v.range, mapWith(MeasureEntity, Measure, v => v.ratio))
}
