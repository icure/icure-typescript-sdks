...
function forMember_DelegationEntity_owner() {
    return forMember<Delegation, DelegationEntity>(v => v.owner, mapFrom(v => v.owner))
}

function forMember_DelegationEntity_delegatedTo() {
    return forMember<Delegation, DelegationEntity>(v => v.delegatedTo, mapFrom(v => v.delegateTo))
}

function forMember_DelegationEntity_key() {
    return forMember<Delegation, DelegationEntity>(v => v.key, mapFrom(v => v.key))
}
...
function forMember_Delegation_owner() {
    return forMember<DelegationEntity, Delegation>(v => v.owner, mapFrom(v => v.owner))
}

function forMember_Delegation_delegateTo() {
    return forMember<DelegationEntity, Delegation>(v => v.delegateTo, mapFrom(v => v.delegatedTo))
}

function forMember_Delegation_key() {
    return forMember<DelegationEntity, Delegation>(v => v.key, mapFrom(v => v.key))
}
...
export function initializeDelegationMapper() {
    ...
    createMap(mapper, DelegationEntity, Delegation, forMember_Delegation_owner(), forMember_Delegation_delegateTo(), forMember_Delegation_key())
}
