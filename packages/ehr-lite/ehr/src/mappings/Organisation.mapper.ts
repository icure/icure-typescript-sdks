...
import {
    convertDeepNestedMapToObject, convertMapToObject, convertNestedMapToObject,
    convertObjectToDeepNestedMap, convertObjectToMap, convertObjectToNestedMap,
    extractAesExchangeKeys,
    extractHcPartyKeys,
    extractPrivateKeyShamirPartitions, extractPublicKey,
    extractTransferKeys
...
function forMember_HealthcareParty_id() {
    return forMember<Organisation, HealthcareParty>(v => v.id, mapFrom(v => v.id))
}

function forMember_HealthcareParty_rev() {
    return forMember<Organisation, HealthcareParty>(v => v.rev, mapFrom(v => v.rev))
}

function forMember_HealthcareParty_created() {
    return forMember<Organisation, HealthcareParty>(v => v.created, mapFrom(v => v.created))
}

function forMember_HealthcareParty_modified() {
    return forMember<Organisation, HealthcareParty>(v => v.modified, mapFrom(v => v.modified))
}

function forMember_HealthcareParty_deletionDate() {
    return forMember<Organisation, HealthcareParty>(v => v.deletionDate, mapFrom(v => v.deletionDate))
}

function forMember_HealthcareParty_identifier() {
    return forMember<Organisation, HealthcareParty>(v => v.identifier, mapWith(IdentifierEntity, Identifier, v => v.identifiers))
}

function forMember_HealthcareParty_tags() {
    return forMember<Organisation, HealthcareParty>(v => v.tags, mapWith(CodeStub, CodingReference, v => v.tags))
}

function forMember_HealthcareParty_codes() {
    return forMember<Organisation, HealthcareParty>(v => v.codes, mapWith(CodeStub, CodingReference, v => v.codes))
}

function forMember_HealthcareParty_name() {
    return forMember<Organisation, HealthcareParty>(v => v.name, mapFrom(v => v.name))
}
...
function forMember_HealthcareParty_userId() {
    return forMember<Organisation, HealthcareParty>(v => v.userId, mapFrom(v => v.userId))
}

function forMember_HealthcareParty_parentId() {
    return forMember<Organisation, HealthcareParty>(v => v.parentId, mapFrom(v => v.parentId))
}
...
function forMember_HealthcareParty_addresses() {
    return forMember<Organisation, HealthcareParty>(v => v.addresses, mapWith(Address, Location, v => v.addresses))
}

function forMember_HealthcareParty_languages() {
    return forMember<Organisation, HealthcareParty>(v => v.languages, mapFrom(v => v.languages))
}

function forMember_HealthcareParty_picture() {
    return forMember<Organisation, HealthcareParty>(v => v.picture, mapFrom(v => v.picture))
}
...
function forMember_HealthcareParty_descr() {
    return forMember<Organisation, HealthcareParty>(v => v.descr, mapFrom(v => v.description))
}
...
function forMember_HealthcareParty_properties() {
    return forMember<Organisation, HealthcareParty>(v => v.properties, mapWith(PropertyStub, Property, v => v.properties))
}

function forMember_HealthcareParty_hcPartyKeys() {
    return forMember<Organisation, HealthcareParty>(v => v.hcPartyKeys, mapFrom(v => Object.fromEntries(extractHcPartyKeys(v.systemMetaData)?.entries() ?? [])))
}

function forMember_HealthcareParty_aesExchangeKeys() {
    return forMember<Organisation, HealthcareParty>(v => v.aesExchangeKeys, mapFrom(v => {
...
function forMember_HealthcareParty_transferKeys() {
    return forMember<Organisation, HealthcareParty>(v => v.transferKeys, mapFrom(v => {
...
function forMember_HealthcareParty_privateKeyShamirPartitions() {
    return forMember<Organisation, HealthcareParty>(v => v.privateKeyShamirPartitions, mapFrom(v => {
...
function forMember_HealthcareParty_publicKey() {
    return forMember<Organisation, HealthcareParty>(v => v.publicKey, mapFrom(v => extractPublicKey(v.systemMetaData)))
}

function forMember_Organisation_id() {
    return forMember<HealthcareParty, Organisation>(v => v.id, mapFrom(v => v.id))
}

function forMember_Organisation_rev() {
    return forMember<HealthcareParty, Organisation>(v => v.rev, mapFrom(v => v.rev))
}

function forMember_Organisation_created() {
    return forMember<HealthcareParty, Organisation>(v => v.created, mapFrom(v => v.created))
}

function forMember_Organisation_modified() {
    return forMember<HealthcareParty, Organisation>(v => v.modified, mapFrom(v => v.modified))
}

function forMember_Organisation_tags() {
    return forMember<HealthcareParty, Organisation>(v => v.tags, mapWith(CodingReference, CodeStub, v => v.tags))
}

function forMember_Organisation_codes() {
    return forMember<HealthcareParty, Organisation>(v => v.codes, mapWith(CodingReference, CodeStub, v => v.codes))
}

function forMember_Organisation_deletionDate() {
    return forMember<HealthcareParty, Organisation>(v => v.deletionDate, mapFrom(v => v.deletionDate))
}

function forMember_Organisation_name() {
    return forMember<HealthcareParty, Organisation>(v => v.name, mapFrom(v => v.name))
}

function forMember_Organisation_parentId() {
    return forMember<HealthcareParty, Organisation>(v => v.parentId, mapFrom(v => v.parentId))
}

function forMember_Organisation_addresses() {
    return forMember<HealthcareParty, Organisation>(v => v.addresses, mapWith(Location, Address, v => v.addresses))
}

function forMember_Organisation_languages() {
    return forMember<HealthcareParty, Organisation>(v => v.languages, mapFrom(v => v.languages))
}

function forMember_Organisation_picture() {
    return forMember<HealthcareParty, Organisation>(v => v.picture, mapFrom(v => v.picture))
}

function forMember_Organisation_description() {
    return forMember<HealthcareParty, Organisation>(v => v.description, mapFrom(v => v.descr))
}

function forMember_Organisation_properties() {
    return forMember<HealthcareParty, Organisation>(v => v.properties, mapWith(Property, PropertyStub, v => v.properties))
}

function forMember_Organisation_systemMetaData() {
    return forMember<HealthcareParty, Organisation>(v => v.systemMetaData, mapFrom(v => {
...
export function initializeOrganisationMapper() {
    ...
    createMap(mapper, HealthcareParty, Organisation, forMember_Organisation_id(), forMember_Organisation_rev(), forMember_Organisation_created(), forMember_Organisation_modified(), forMember_Organisation_identifiers(), forMember_Organisation_tags(), forMember_Organisation_codes(), forMember_Organisation_deletionDate(), forMember_Organisation_name(), forMember_Organisation_parentId(), forMember_Organisation_addresses(), forMember_Organisation_languages(), forMember_Organisation_picture(), forMember_Organisation_description(), forMember_Organisation_properties(), forMember_Organisation_systemMetaData())
}

function forMember_Organisation_identifiers() {
    return forMember<HealthcareParty, Organisation>(v => v.identifiers, mapWith(Identifier, IdentifierEntity, v => v.identifier))
}
