...
function forMember_Address_addressType() {
    return forMember<Location, Address>(v => v.addressType, mapFrom(v => v.addressType))
}

function forMember_Address_descr() {
    return forMember<Location, Address>(v => v.descr, mapFrom(v => v.description))
}

function forMember_Address_street() {
    return forMember<Location, Address>(v => v.street, mapFrom(v => v.street))
}

function forMember_Address_houseNumber() {
    return forMember<Location, Address>(v => v.houseNumber, mapFrom(v => v.houseNumber))
}

function forMember_Address_postboxNumber() {
    return forMember<Location, Address>(v => v.postboxNumber, mapFrom(v => v.postboxNumber))
}

function forMember_Address_postalCode() {
    return forMember<Location, Address>(v => v.postalCode, mapFrom(v => v.postalCode))
}

function forMember_Address_city() {
    return forMember<Location, Address>(v => v.city, mapFrom(v => v.city))
}

function forMember_Address_state() {
    return forMember<Location, Address>(v => v.state, mapFrom(v => v.state))
}

function forMember_Address_country() {
    return forMember<Location, Address>(v => v.country, mapFrom(v => v.country))
}
...
function forMember_Address_notes() {
    return forMember<Location, Address>(v => v.notes, mapWith(AnnotationEntity, Annotation,v => v.notes))
}

function forMember_Address_telecoms() {
    return forMember<Location, Address>(v => v.telecoms, mapWith(Telecom, ContactPoint, v => v.telecoms))
}

function forMember_Address_encryptedSelf() {
    return forMember<Location, Address>(v => v.encryptedSelf, mapFrom(v => v.encryptedSelf))
}

function forMember_Location_addressType() {
    return forMember<Address, Location>(v => v.addressType, mapFrom(v => v.addressType))
}

function forMember_Location_description() {
    return forMember<Address, Location>(v => v.description, mapFrom(v => v.descr))
}

function forMember_Location_street() {
    return forMember<Address, Location>(v => v.street, mapFrom(v => v.street))
}

function forMember_Location_houseNumber() {
    return forMember<Address, Location>(v => v.houseNumber, mapFrom(v => v.houseNumber))
}

function forMember_Location_postboxNumber() {
    return forMember<Address, Location>(v => v.postboxNumber, mapFrom(v => v.postboxNumber))
}

function forMember_Location_postalCode() {
    return forMember<Address, Location>(v => v.postalCode, mapFrom(v => v.postalCode))
}

function forMember_Location_city() {
    return forMember<Address, Location>(v => v.city, mapFrom(v => v.city))
}

function forMember_Location_state() {
    return forMember<Address, Location>(v => v.state, mapFrom(v => v.state))
}

function forMember_Location_country() {
    return forMember<Address, Location>(v => v.country, mapFrom(v => v.country))
}

function forMember_Location_notes() {
    return forMember<Address, Location>(v => v.notes, mapWith(Annotation, AnnotationEntity,v => v.notes))
}

function forMember_Location_telecoms() {
    return forMember<Address, Location>(v => v.telecoms, mapWith(ContactPoint, Telecom, v => v.telecoms))
}
...
function forMember_Location_encryptedSelf() {
    return forMember<Address, Location>(v => v.encryptedSelf, mapFrom(v => v.encryptedSelf))
}
