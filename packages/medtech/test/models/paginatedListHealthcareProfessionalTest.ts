...
describe('PaginatedListHealthcareProfessional model test', () => {
  it('Marshalling/Unmarshalling of PaginatedListHealthcareProfessional model - Success', () => {
    ...
    const unmarshalledPaginatedListHealthcareProfessional = new PaginatedListHealthcareProfessional(
      JSON.parse(JSON.stringify(marshalledPaginatedListHealthcareProfessional))
    )
