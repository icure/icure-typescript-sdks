...
export namespace AnonymousMedTech {
  export class Builder extends AnonymousApiBuilder<CryptoStrategies<DataOwnerWithType>, AnonymousMedTechApi> {
    protected doBuild(props: {
      ...
      return Promise.resolve(new AnonymousMedTechApi(
          props.iCureBaseUrl,
          props.msgGwUrl,
          props.msgGwSpecId,
          props.storage,
