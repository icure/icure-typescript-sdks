...
import {MedTech, MedTechApi} from './MedTechApi'
...
export class AuthenticationApi extends AuthenticationApiImpl<MedTechApi> {
    ...
    async authenticateAndAskAccessToItsExistingData(userLogin: string, shortLivedToken: string): Promise<AuthenticationResult<MedTechApi>> {
