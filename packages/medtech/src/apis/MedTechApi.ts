...
export namespace MedTech {
    export class Builder extends AuthenticatedApiBuilder<CryptoStrategies<DataOwnerWithType>, MedTechApi> {
    ...
    export const api = (api?: MedTechApi) => {
